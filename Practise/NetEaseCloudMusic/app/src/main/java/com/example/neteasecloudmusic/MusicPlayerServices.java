...
public class MusicPlayerServices extends Service {
    ...
    public IBinder onBind(Intent intent) {
        return new MusicControl();//绑定服务的时刻，把音乐控制实例化
    }
    ...
    public void addTimer(){
        if (timer == null){
            ...
            //开始计时任务后的五毫秒，第一次执行task任务，以后美500毫秒执行一次
    ...
    class MusicControl extends Binder{
        ...
        public void play(){
            mediaPlayer.reset();
            mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.qingtian);
            mediaPlayer.start();
            addTimer();
        }
        //暂停
