...
public class MainActivity extends AppCompatActivity {
    ...
    private static TextView currentTv;//当前音乐播放时常
    ...
    public void init(){
        ...
        animator = ObjectAnimator.ofFloat(iv_disk,"rotation",0,360.0F);//对象是iv_disk，动作是rotation旋转，角度从0-360，这里用的是浮点数，所以加一个F
        animator.setDuration(10000);//这里设置动画的时长，单位为毫秒，这里设置了10秒转一圈
        animator.setInterpolator(new LinearInterpolator());//旋转时间函数为线性，匀速旋转
